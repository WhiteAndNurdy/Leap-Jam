...
public class SplashScreen : MonoBehaviour
{
	...
	public bool skipWithInput = false;
	...
	void OnGUI()
	{
		...
		if (splashLogo != null)
		{
			...
			if (alpha > 1.0f)
			{
				GameManager.instance.SplashScreenFadeInComplete(splashName);
			...
			if (alpha < 0.0f)
			{
				GameManager.instance.SplashScreenFadeOutComplete(splashName);
				status = FadeStatus.Paused;
				alpha = 0.0f;
			}
		}
