...
public class CameraBorderMovement : MonoBehaviour 
{
	...
	private SpellCastLogic spellCastLogic;

	void Awake()
	{
		spellCastLogic = transform.GetComponentInChildren<SpellCastLogic>();
	}

	void Start()
	{
		DebugUtils.Assert(spellCastLogic != null, "Couldn't find spelcastlogic!");
	}
